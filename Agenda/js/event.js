class Evenement {
    ...
    constructor() {
        ...
        this.draw_event = function() {
            var month = ["Janvier", "Février", "Mars",
            ...
            this.event_liste.filter(e => actual_date - new Date(e[5]) < 0).forEach(e => {
                ...
                let event_section_list_test = [event_start_date_bd.getDate(), event_start_date_bd.getMonth(), event_start_date_bd.getFullYear()];
                if (!this.is_in(event_section_list, event_section_list_test)) {
                    ...
                    event_section.innerHTML = "Événement du " + event_section_list_test[0] + " " + month[event_section_list_test[1]] + " " + event_section_list_test[2];
                ...
                event_time.innerHTML = event_start_date_string + event_end_date_string;
